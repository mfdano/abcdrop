  ...
  <head>
    ...
    <style type="text/css">
      body {
            ...
            div[id ^='contenedor'] {
                width:1024px;
                height:620px;
                background:url({{ asset('img/farm/farm.jpg') }}) no-repeat;
    ...
    <script>
      ...
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/farm.mp3') }}";
          audio.volume = 0.1
          audio.play();
      }
      ...
      function au1() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/caballo.mp3') }}";
          audio.play();
      }
      }
      ...
      function au2() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/tigre.mp3') }}";
          audio.play();
      }
      }
      ...
      function au3() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/vaca.mp3') }}";
          audio.play();
      }
      }
      ...
      function au4() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/lobo.mp3') }}";
          audio.play();
      }
      }
      ...
      function au5() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/gallo.mp3') }}";
          audio.play();
      }
      }
      ...
      function au6() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/perro.mp3') }}";
          audio.play();
      }
      }
      ...
      function au7() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/pato.mp3') }}";
          audio.play();
      }
      }
      ...
      function au8() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/zorro.mp3') }}";
          audio.play();
      }
      }
      ...
      function au9() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/oveja.mp3') }}";
          audio.play();
      }
      }
      ...
      function au10() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/pingüino.mp3') }}";
          audio.play();
      }
      }
      ...
      function au11() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/cerdo.mp3') }}";
          audio.play();
      }
      }
      ...
      function au12() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/llama.mp3') }}";
          audio.play();
      }
      }
      ...
      function au13() {
        var audio = document.createElement("audio");
      if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
          audio.src = "{{ asset('audio/abeja.mp3') }}";
          audio.play();
      }
      }
  ...
  <body>
    ...
    <div class="ui main container">
      ...
      <section>
            ...
            <!-- ítems -->
            <IMG SRC="{{ asset('img/farm/horse.png') }}" WIDTH=80 HEIGHT=80 id="caja1" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au1()">
            <IMG SRC="{{ asset('img/farm/tiger.png') }}" WIDTH=80 HEIGHT=80 id="caja2" draggable="true" ondragend="erro()" onmousedown="au2()">
            <IMG SRC="{{ asset('img/farm/cow.png') }}" WIDTH=80 HEIGHT=80 id="caja3" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au3()">
            <IMG SRC="{{ asset('img/farm/wolf.png') }}" WIDTH=80 HEIGHT=80 id="caja4" draggable="true" ondragend="erro()" onmousedown="au4()">
            <IMG SRC="{{ asset('img/farm/cock.png') }}" WIDTH=80 HEIGHT=80 id="caja5" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au5()">
            <IMG SRC="{{ asset('img/farm/dog.png') }}" WIDTH=80 HEIGHT=80 id="caja6" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au6()">
            <IMG SRC="{{ asset('img/farm/duck.png') }}" WIDTH=80 HEIGHT=80 id="caja7" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au7()">
            <IMG SRC="{{ asset('img/farm/fox.png') }}" WIDTH=80 HEIGHT=80 id="caja8" draggable="true" ondragend="erro()" onmousedown="au8()">
            <IMG SRC="{{ asset('img/farm/sheep.png') }}" WIDTH=80 HEIGHT=80 id="caja9" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au9()">
            <IMG SRC="{{ asset('img/farm/penguin.png') }}" WIDTH=80 HEIGHT=80 id="caja10" draggable="true" ondragend="erro()" onmousedown="au10()">
            <IMG SRC="{{ asset('img/farm/pig.png') }}" WIDTH=80 HEIGHT=80 id="caja11" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au11()">
            <IMG SRC="{{ asset('img/farm/llama.png') }}" WIDTH=80 HEIGHT=80 id="caja12" draggable="true" ondragend="erro()" onmousedown="au12()">
            <IMG SRC="{{ asset('img/farm/bee.png') }}" WIDTH=80 HEIGHT=80 id="caja13" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au13()">
            <!-- contenedor -->
