  ...
  <head>
      ...
      body {
        background: #fffff; 
            ...
            div[id ^='contenedor'] {
                width:1024px;
                height:620px;
                background:url({{ asset('img/sports/estadio.jpg') }}) no-repeat;
    ...
    var err=0;
            ...
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/estadio.mp3') }}";
                audio.volume = 0.6
                audio.play();
            }
            ...
            function au1() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/football.mp3') }}";
                audio.play();
            }
            }
            ...
            function au2() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/fresa.mp3') }}";
                audio.play();
            }
            }
            ...
            function au3() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/golf.mp3') }}";
                audio.play();
            }
            }
            ...
            function au4() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/piña.mp3') }}";
                audio.play();
            }
            }
            ...
            function au5() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/baseball.mp3') }}";
                audio.play();
            }
            }
            ...
            function au6() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/pingpong.mp3') }}";
                audio.play();
            }
            }
            ...
            function au7() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/basketball.mp3') }}";
                audio.play();
            }
            }
            ...
            function au8() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/sandwich.mp3') }}";
                audio.play();
            }
            }
            ...
            function au9() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/soccer.mp3') }}";
                audio.play();
            }
            }
            ...
            function au10() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/leche.mp3') }}";
                audio.play();
            }
            }
            ...
            function au11() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/tennis.mp3') }}";
                audio.play();
            }
            }
            ...
            function au12() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/sandia.mp3') }}";
                audio.play();
            }
            }
  ...
  <body>
    ...
    <div class="ui main container">
      ...
      <section>
            ...
            <!-- ítems -->
            <IMG SRC="{{ asset('img/sports/football.png') }}" WIDTH=80 HEIGHT=80 id="caja1" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au1()">
            <IMG SRC="{{ asset('img/sports/fresa.png') }}" WIDTH=80 HEIGHT=80 id="caja2" draggable="true" ondragend="erro()" onmousedown="au2()">
            <IMG SRC="{{ asset('img/sports/golf.png') }}" WIDTH=80 HEIGHT=80 id="caja3" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au3()">
            <IMG SRC="{{ asset('img/sports/piña.png') }}" WIDTH=80 HEIGHT=80 id="caja4" draggable="true" ondragend="erro()" onmousedown="au4()">
            <IMG SRC="{{ asset('img/sports/baseball.png') }}" WIDTH=80 HEIGHT=80 id="caja5" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au5()">
            <IMG SRC="{{ asset('img/sports/pingpong.png') }}" WIDTH=80 HEIGHT=80 id="caja6" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au6()">
            <IMG SRC="{{ asset('img/sports/basketball.png') }}" WIDTH=80 HEIGHT=80 id="caja7" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au7()">
            <IMG SRC="{{ asset('img/sports/sandwich.png') }}" WIDTH=80 HEIGHT=80 id="caja8" draggable="true" ondragend="erro()" onmousedown="au8()">
            <IMG SRC="{{ asset('img/sports/soccer.png') }}" WIDTH=80 HEIGHT=80 id="caja9" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au9()">
            <IMG SRC="{{ asset('img/sports/leche.png') }}" WIDTH=80 HEIGHT=80 id="caja10" draggable="true" ondragend="erro()" onmousedown="au10()">
            <IMG SRC="{{ asset('img/sports/tennis.png') }}" WIDTH=80 HEIGHT=80 id="caja11" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au11()">
            <IMG SRC="{{ asset('img/sports/sandia.png') }}" WIDTH=80 HEIGHT=80 id="caja12" draggable="true" ondragend="erro()" onmousedown="au12()">
            <IMG SRC="{{ asset('img/sports/box.png') }}" WIDTH=80 HEIGHT=80 id="caja13" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au13()">
            <!-- contenedor -->
