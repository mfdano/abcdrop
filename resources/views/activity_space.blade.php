  ...
  <head>
      ...
      body {
        background: #fffff; 
            ...
            div[id ^='contenedor'] {
                width:1024px;
                height:620px;
                background:url({{ asset('img/space/space.jpg') }}) no-repeat;
    ...
    var err=0;
            ...
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/space.mp3') }}";
                audio.play();
            }
            ...
            function au1() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/galaxia.mp3') }}";
                audio.play();
            }
            }
            ...
            function au2() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/granjero.mp3') }}";
                audio.play();
            }
            }
            ...
            function au3() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/cohete.mp3') }}";
                audio.play();
            }
            }
            ...
            function au4() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/hoja.mp3') }}";
                audio.play();
            }
            }
            ...
            function au5() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/mercurio.mp3') }}";
                audio.play();
            }
            }
            ...
            function au6() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/sistema.mp3') }}";
                audio.play();
            }
            }
            ...
            function au7() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/planetas.mp3') }}";
                audio.play();
            }
            }
            ...
            function au8() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/carretilla.mp3') }}";
                audio.play();
            }
            }
            ...
            function au9() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/saturno.mp3') }}";
                audio.play();
            }
            }
            ...
            function au10() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/pala.mp3') }}";
                audio.play();
            }
            }
            ...
            function au11() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/tierra.mp3') }}";
                audio.play();
            }
            }
            ...
            function au12() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/trigo.mp3') }}";
                audio.play();
            }
            }
            ...
            function au13() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/luna.mp3') }}";
                audio.play();
            }
            }
  ...
  <body>
    ...
    <div class="ui main container">
      ...
      <section>
            ...
            <!-- ítems -->
            <IMG SRC="{{ asset('img/space/galaxia.png') }}" WIDTH=80 HEIGHT=80 id="caja1" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au1()">
            <IMG SRC="{{ asset('img/space/farmer.png') }}" WIDTH=80 HEIGHT=80 id="caja2" draggable="true" ondragend="erro()" onmousedown="au2()">
            <IMG SRC="{{ asset('img/space/cohete.png') }}" WIDTH=80 HEIGHT=80 id="caja3" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au3()">
            <IMG SRC="{{ asset('img/space/leaf.png') }}" WIDTH=80 HEIGHT=80 id="caja4" draggable="true" ondragend="erro()" onmousedown="au4()">
            <IMG SRC="{{ asset('img/space/mercurio.png') }}" WIDTH=80 HEIGHT=80 id="caja5" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au5()">
            <IMG SRC="{{ asset('img/space/sistema.png') }}" WIDTH=80 HEIGHT=80 id="caja6" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au6()">
            <IMG SRC="{{ asset('img/space/planetas.png') }}" WIDTH=80 HEIGHT=80 id="caja7" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au7()">
            <IMG SRC="{{ asset('img/space/carretilla.png') }}" WIDTH=80 HEIGHT=80 id="caja8" draggable="true" ondragend="erro()" onmousedown="au8()">
            <IMG SRC="{{ asset('img/space/saturno.png') }}" WIDTH=80 HEIGHT=80 id="caja9" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au9()">
            <IMG SRC="{{ asset('img/space/shovel.png') }}" WIDTH=80 HEIGHT=80 id="caja10" draggable="true" ondragend="erro()" onmousedown="au10()">
            <IMG SRC="{{ asset('img/space/tierra.png') }}" WIDTH=80 HEIGHT=80 id="caja11" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au11()">
            <IMG SRC="{{ asset('img/space/trigo.png') }}" WIDTH=80 HEIGHT=80 id="caja12" draggable="true" ondragend="erro()" onmousedown="au12()">
            <IMG SRC="{{ asset('img/space/luna.png') }}" WIDTH=80 HEIGHT=80 id="caja13" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au13()">
            <!-- contenedor -->
