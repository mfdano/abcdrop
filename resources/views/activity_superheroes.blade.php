...
<html lang="es">
  <head>
      ...
      body {
        background: #fffff; 
            ...
            div[id ^='contenedor'] {
                width:1024px;
                height:620px;
                background:url({{ asset('img/superheroes/city.jpg') }}) no-repeat;
    ...
    var err=0;
            ...
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/city.mp3') }}";
                audio.play();
            }
            ...
            function au1() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/wolverine.mp3') }}";
                audio.play();
            }
            }
            ...
            function au2() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/empleado.mp3') }}";
                audio.play();
            }
            }
            ...
            function au3() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/deadpool.mp3') }}";
                audio.play();
            }
            }
            ...
            function au4() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/hombre.mp3') }}";
                audio.play();
            }
            }
            ...
            function au5() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/thor.mp3') }}";
                audio.play();
            }
            }
            ...
            function au6() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/spiderman.mp3') }}";
                audio.play();
            }
            }
            ...
            function au7() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/camerica.mp3') }}";
                audio.play();
            }
            }
            ...
            function au8() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/oficinista.mp3') }}";
                audio.play();
            }
            }
            ...
            function au9() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/flash.mp3') }}";
                audio.play();
            }
            }
            ...
            function au10() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/mesero.mp3') }}";
                audio.play();
            }
            }
            ...
            function au11() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/batman.mp3') }}";
                audio.play();
            }
            }
            ...
            function au12() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/operador.mp3') }}";
                audio.play();
            }
            }
            ...
            function au13() {
              var audio = document.createElement("audio");
            if (audio != null && audio.canPlayType && audio.canPlayType("audio/mpeg")){
                audio.src = "{{ asset('audio/ironman.mp3') }}";
                audio.play();
            }
            }
  ...
  <body>
    ...
    <div class="ui main container">
      ...
      <section>
        <!-- ítems -->
            <IMG SRC="{{ asset('img/superheroes/wolverine.png') }}" WIDTH=80 HEIGHT=80 id="caja1" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au1()">
            <IMG SRC="{{ asset('img/superheroes/empleado.png') }}" WIDTH=80 HEIGHT=80 id="caja2" draggable="true" ondragend="erro()" onmousedown="au2()">
            <IMG SRC="{{ asset('img/superheroes/deadpool.png') }}" WIDTH=80 HEIGHT=80 id="caja3" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au3()">
            <IMG SRC="{{ asset('img/superheroes/hombre.png') }}" WIDTH=80 HEIGHT=80 id="caja4" draggable="true" ondragend="erro()" onmousedown="au4()">
            <IMG SRC="{{ asset('img/superheroes/thor.png') }}" WIDTH=80 HEIGHT=80 id="caja5" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au5()">
            <IMG SRC="{{ asset('img/superheroes/spiderman.png') }}" WIDTH=80 HEIGHT=80 id="caja6" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au6()">
            <IMG SRC="{{ asset('img/superheroes/camerica.png') }}" WIDTH=80 HEIGHT=80 id="caja7" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au7()">
            <IMG SRC="{{ asset('img/superheroes/oficinista.png') }}" WIDTH=80 HEIGHT=80 id="caja8" draggable="true" ondragend="erro()" onmousedown="au8()">
            <IMG SRC="{{ asset('img/superheroes/flash.png') }}" WIDTH=80 HEIGHT=80 id="caja9" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au9()">
            <IMG SRC="{{ asset('img/superheroes/mesero.png') }}" WIDTH=80 HEIGHT=80 id="caja10" draggable="true" ondragend="erro()" onmousedown="au10()">
            <IMG SRC="{{ asset('img/superheroes/batman.png') }}" WIDTH=80 HEIGHT=80 id="caja11" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au11()">
            <IMG SRC="{{ asset('img/superheroes/operador.png') }}" WIDTH=80 HEIGHT=80 id="caja12" draggable="true" ondragend="erro()" onmousedown="au12()">
            <IMG SRC="{{ asset('img/superheroes/ironman.png') }}" WIDTH=80 HEIGHT=80 id="caja13" draggable="true" ondragstart="dragstart(this, event)" onmousedown="au13()">
            <!-- contenedor -->
